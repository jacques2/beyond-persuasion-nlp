...
deployments, thereby protecting the user's deliberative autonomy.
...
emotional fragility for commercial gain, while common, is not justified. Therefore, it
refuses to apply the conventional commercial behavior when the user is fragile.
...
The project operationalizes key principles of Trustworthy AI as defined by the AI
High-Level Expert Group \cite{hleg2019}:
\begin{itemize}[leftmargin=1.8em]
\item \textbf{Respect for human autonomy:} human agency is protected because the system
dynamically disables nudging and persuasion tactics, avoiding steering vulnerable users
...
a legal classification tool, and it does not claim that temporary emotional vulnerability
automatically satisfies the legal categories used by the Regulation. However, it translates
the same regulatory intuition into software design: if an AI system detects that the user is
in a fragile state, it should not amplify commercial pressure or directive persuasion. The
ethical layer is therefore a practical safeguard inspired by the AI Act's concern with
autonomy, vulnerability, and behavioral distortion.
...
transition highlighted by the GDPR/profiling debate: from observing behavior, to inferring
...
protected prompt. They are part of the project's ethical design, not merely implementation
details.
...
were all mixed emotional prompts, which is exactly where the project becomes most
interesting to discuss. This count refers to the binary ethical condition
...
layer can override that pressure in emotionally vulnerable contexts.
